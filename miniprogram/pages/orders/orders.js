...
Page({
  ...
  openHome() { wx.reLaunch({ url: '/pages/home/home' }); }, openCart() { wx.reLaunch({ url: '/pages/cart/cart' }); }, openMessages() { wx.reLaunch({ url: '/pages/messages/messages' }); }, openAddress() { wx.reLaunch({ url: '/pages/address/address' }); }
});
