...
用户确认在现有 Web 系统补齐滚动和搜索并上线。发布提交为 5736d8112bc47251de3e335fc4455647e564bce5，已推送至既有分支 release/v1.5.0-mini-courier，标签 v1.5.2 指向该功能提交。小程序 AppID wx8b70a3e92105d869 和本地 urlCheck 配置仍只保留在未提交的开发者工具文件中；用户提供的 gh_5589e0aad2a2 是微信原始 ID，不是 AppID，因此没有替换可用配置。
